        ...
        (a = (function () {
                ...
                ? ((this.$el = n(this.options.form)),
                  this.options.container
                    ? ((this.$container = n(this.options.container)),
                      (a = n.isDOMElement(this.$container) ? this.$container : this.$container[0]).getAttribute(
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              for (t in (n.append(
                this.$container,
                this.template(this.cardTemplate, o({}, this.options.messages, this.options.placeholders))
              ),
              ...
              if (
                ...
                this.options.width &&
                  ...
                  (e = parseInt(r.clientWidth || window.getComputedStyle(r).width)),
            ...
            (t.prototype.toggleValidClass = function (r, e) {
              return (
                n.toggleClass(r, this.options.classes.valid, e), n.toggleClass(r, this.options.classes.invalid, !e)
              );
            }),
            ...
            (e = function (r, e, t, a) {
              ...
              for (b = [], i = p = 0, s = e.length; p < s; i = ++p)
                (f = e[i]), (g = a.fill ? j + t[i].substring(j.length) : j || t[i]), b.push((f.textContent = g));
              return b;
            }),
            t
          );
        ...
        (r.i = function (e, t) {
          ...
          for (n = 0; n < e.length; n++) {
            ...
            ("number" == typeof i[0] && a[i[0]]) ||
              (t && !i[2] ? (i[2] = t) : t && (i[2] = "(" + i[2] + ") and (" + t + ")"), r.push(i));
          }
        }),
        r
      );
  ...
  function (r, e) {
    ...
    function s(r, e) {
      var t = o(),
        a = c[c.length - 1];
      if ("top" === r.insertAt)
        a ? (a.nextSibling ? t.insertBefore(e, a.nextSibling) : t.appendChild(e)) : t.insertBefore(e, t.firstChild),
          c.push(e);
      else {
        ...
        (n = t(1)),
          ...
          (j = function (r) {
            ...
            try {
              ...
              if (
                null !=
                  ("undefined" != typeof document && null !== document && null != (t = document.selection)
                    ? t.createRange
                    : void 0) &&
          ...
          (m = function (r) {
            return setTimeout(function () {
              var e, t;
              return (
                (e = r.target), (t = n.val(e)), (t = a.fns.formatCardNumber(t)), n.val(e, t), n.trigger(e, "change")
              );
            });
          }),
          (s = function (r) {
            return function (e) {
              ...
              if (((a = String.fromCharCode(e.which)), /^\d+$/.test(a))) {
                ...
                if (!j(l))
                  return (t && "amex" === t.type ? /^(\d{4}|\d{4}\s\d{6})$/ : /(?:^|\s)(\d{4})$/).test(g)
                    ? (e.preventDefault(), n.val(l, g + " " + a), n.trigger(l, "change"))
                    : void 0;
              }
            };
          }),
          ...
          (g = function (r) {
            ...
            if (((e = String.fromCharCode(r.which)), /^\d+$/.test(e)))
              return (
                (t = r.target),
                (a = n.val(t)),
                /^\d\d$/.test(a) ? (n.val(t, a + " / "), n.trigger(t, "change")) : void 0
              );
          }),
          (u = function (r) {
            var e, t;
            if ("/" === String.fromCharCode(r.which))
              return (
                (e = r.target),
                (t = n.val(e)),
                /^\d$/.test(t) && "0" !== t ? (n.val(e, "0" + t + " / "), n.trigger(e, "change")) : void 0
              );
          }),
          (l = function (r) {
            var e, t;
          ...
          (C = function (r) {
            ...
            return (
              ...
              (32 === r.which
                ...
                : 0 === r.which ||
                  r.which < 33 ||
                  ((e = String.fromCharCode(r.which)), /[\d\s]/.test(e) ? void 0 : r.preventDefault()))
            );
          }),
          (x = function (r) {
            return function (e) {
          ...
          (k = function (r, e) {
            var t, a;
            if (((a = r.target), (t = String.fromCharCode(r.which)), /^\d+$/.test(t) && !j(a)))
              return (n.val(a) + t).replace(/\D/g, "").length > e ? r.preventDefault() : void 0;
          }),
          (y = function (r) {
            return k(r, 6);
          }),
          ...
          (v = function (r) {
            var e, t;
            if (((t = r.target), (e = String.fromCharCode(r.which)), /^\d+$/.test(e) && !j(t)))
              ...
              (r.fns = {
                ...
                validateCardNumber: function (r) {
                  ...
                  return (
                    ...
                    !!/^\d+$/.test(r) &&
                      !!(e = o(r)) &&
                      ((t = r.length), $.call(e.length, t) >= 0 && (!1 === e.luhn || h(r)))
                  );
                },
                  ...
                  return (
                    ...
                    !(!e || !t) &&
                      ...
                      !!/^\d+$/.test(e) &&
                        ...
                        (2 === t.length && (t = new Date().getFullYear().toString().slice(0, 2) + t),
                        (o = new Date(t, e)),
                        (a = new Date()),
                ...
                validateCardCVC: function (r, e) {
                  ...
                  return (
                    ...
                    !!/^\d+$/.test(r) &&
                      (e && i(e)
                        ? ((t = r.length), $.call(null != (a = i(e)) ? a.cvcLength : void 0, t) >= 0)
            ...
            (t = c(l, e)),
              l !== (n = c(r, e)) &&
                (g && n && (a.hash(n) || (o = a.array(n)))
                  ? (o ? ((o = !1), (i = t && a.array(t) ? t : [])) : (i = t && a.hash(t) ? t : {}),
                    d(l, e, p(g, i, n)))
                  : void 0 !== n && d(l, e, n));
      return l;
    }
  ...
  function (r, e, t) {
    ...
    r.exports = function (r) {
      ...
      for (
        ...
        p.push("$" + l);
      if (
        ((t = Function("binder", "return function (" + p.join(",") + "){ return binder.apply(this,arguments); }")(d)),
        e.prototype)
      ) {
        var s = function () {};
